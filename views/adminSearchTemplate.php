...
<body>
    <div class="container">
        ...
        <div class="search">
            <div class="search__inner">
                <input class="search-input search-input--admin" type="text" value="<?=$_GET["word"]?>" placeholder="Поиск + Enter">
    ...
    <script>
        ...
        let lessonsItemNames = document.querySelectorAll(".admin-lessons__item-name");

        let searchInput = document.querySelector(".search-input--admin");
